...
pub const SUITES: &[Suite] = &[
    ...
    Suite {
        name: "trace",
        about: "the router's own reasoning is recorded whole, or not at all",
        run: crate::ai::trace::selftest,
    },
    Suite {
        name: "render",
    ...
    Suite {
        name: "answer",
        about: "whether retrieval helps, and whether this can tell",
        run: crate::ai::answer::selftest,
    },
    Suite {
        name: "outcome",
        about: "how far apart two applets are, measured by what they printed",
        run: crate::ai::outcome::selftest,
    },
    Suite {
        name: "route",
    ...
    Suite {
        name: "rail",
        about: "the rail report's shape, without paying to measure any of them",
        run: crate::bench::selftest,
    },
    Suite {
        name: "knob",
        about: "the constants this machine may propose changing about itself",
        run: crate::ai::knob::selftest,
    },
    Suite {
        name: "request",
        about: "what this machine will and will not put on the wire",
        run: crate::net::tls::selftest,
    },
    Suite {
        name: "clade",
        about: "which node to grow from, by what already grew from it",
        run: crate::ai::clade::selftest,
    },
    Suite {
        name: "progress",
        about: "how well this machine predicts its own history, in bits",
        run: crate::ai::progress::selftest,
    },
    Suite {
        name: "oops",
        about: "how much a night may spend, and why it cannot waste much",
        run: crate::ai::oops::selftest,
    },
];
